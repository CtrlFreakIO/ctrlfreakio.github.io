...
- PLC programming: Siemens TIA Portal, Step 7, Allen-Bradley Studio5000
- Safety controller programming and functional safety assessment (EN ISO 13849-1)
- Drive configuration and diagnostics (Sinamics, PROFINET)
- Industrial communication protocols: PROFINET, Modbus TCP/RTU, Ethernet/IP
- HMI and SCADA development
- IT/OT integration: Python (snap7), SQL, PowerShell
- Formal verification: FRET, NuSMV, UPPAAL
- As-built documentation and operator manual preparation
...
Rock climbing, kayaking, drawing, films, music, books

---

*Full profile on [LinkedIn](https://linkedin.com/in/ctrlfreak)*
